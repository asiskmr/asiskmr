...
import com.yashtech.dao.TopicRepository;
...
public class TopicService {
	...
	private List<Topic> topics = new ArrayList<Topic>(Arrays.asList(
			...
			(new Topic("datbase", "Spring data", "description")),
			(new Topic("java script", "java script framework", "js description"))));
